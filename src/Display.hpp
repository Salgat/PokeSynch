...
// Starting at 70,128 and 9x9 (row by row)
std::array<int, 81> const kItemSelectBMP = {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
...
public:
    ...
    bool ItemIsSelected(const sf::Image& image);
